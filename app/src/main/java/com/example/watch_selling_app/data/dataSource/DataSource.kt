...
object DataSource {
    ...
    fun getLoginContent(): LoginContent {
        return LoginContent(
            backgroundImageResId = R.drawable.login_head_image,
    ...
    fun getRegisterContent(): RegisterContent {
        return RegisterContent(
            ...
            exploreButtonLightResId =R.drawable.create_account_light,
            exploreButtonDarkResId = R.drawable.create_accounnt_dark,
